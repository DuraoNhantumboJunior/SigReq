    ...
    if(Input::exists()){
        $user=new User();
            ...
            $query=$user->Enviar($database,array(
                ...
                'ano'=>trim($_POST['ano']),
                'novo_turno' =>trim($_POST['turno_novo']),
...
<div class="container-form">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                <h2>Pedido de Mudança de turno</h2>
                <form action="" method="post">
                    <input type="hidden" name="type" value="turno">
                    <label for="nome">
                    ...
                    <label for="turno_novo">
                        <input type="text" name="turno_novo" placeholder="regime que Deseja" id="turno_novo">
                    </label>
                    <label for="motivo">
