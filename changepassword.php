...
<div class="form-information">
            <div class="form-information-childs">
                <h2>Redefinição de senha do usuário <?php echo escape($user->data()->username); ?></h2>
<form action="" method="POST">
<div class="field">
            <label for="password">Actual Senha</label>
            <input type="password" name="password_current" placeholder="Senha atual" id="password_current">
        </div>
        <div class="field">
