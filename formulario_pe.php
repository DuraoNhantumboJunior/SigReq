     ...
     if($user->isLoggedIn()){
        ...
        if(Input::exists()){
            ...
            $query=$user->Enviar($database,array(
                ...
                'ano'=>trim($_POST['ano']),
                'cadeira_equivalencia' =>trim($_POST['cadeira']),
                'curso_equivalencia' =>trim($_POST['curso1']),
        ...
        <div class="form-information">
            <div class="form-information-childs">
                <h2>Pedido de Equivalência</h2>
                <form action="" method="post">
                    <input type="hidden" name="type" value="equivalencia">
                    <label for="nome">
                    ...
                    <label for="nome_curso1">
                        <input type="text" name="curso1" placeholder="Curso em questão" id="curso1">
                    </label>
                    <label for="cadeira">
                        <input type="text" name="cadeira" placeholder="Cadeira em questão" id="cadeira">
                    </label>
                    <label for="motivo">
